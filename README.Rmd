...
See the [installation page](http://gudhi.inria.fr/python/latest/installation.html) or if you have conda you can make a [conda install](https://anaconda.org/conda-forge/gudhi).
...
knitr::include_graphics("http://gudhi.inria.fr/python/latest/_images/Simplex_tree_representation.png")
```
